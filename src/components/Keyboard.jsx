    ...
    return (
      <div>
        <div className="keyboard-row">
          ...
          <Key  Tag="&radic;x" keyLog="&radic;(" math="sqrt" keyClick={keyClick} />
          <Key  Tag="^" keyLog="^" math="power" keyClick={keyClick} />
          <Key  Tag="CLEAR" math="clear" keyClick={keyClick} />
        </div>
       
        <div className="keyboard-row">
          <Key  keyLog="&Pi;" Tag="&Pi;" math="pi" keyClick={keyClick} />
